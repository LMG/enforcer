...
extern FUNC(void, OS_CODE) tpl_primary_syscall_handler(P2CONST(void, OS_APPL_DATA, AUTOMATIC));
extern FUNC(void, OS_CODE) DebugMonitor_Handler(P2CONST(void, OS_APPL_DATA, AUTOMATIC));
extern FUNC(void, OS_CODE) SysTick_Handler(P2CONST(void, OS_APPL_DATA, AUTOMATIC));
...
__attribute__ ((section(".isr_vector"))) CONST(tpl_it_handler, AUTOMATIC) tpl_it_vectors[98] = {
  ...
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_primary_syscall_handler,
