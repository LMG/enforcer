...
/* os services */
    ...
    (tpl_system_call) tpl_increment_counter_service,
    (tpl_system_call) tpl_get_counter_value_service,
    (tpl_system_call) tpl_get_elapsed_counter_value_service,
    (tpl_system_call) tpl_start_schedule_table_rel_service,
    (tpl_system_call) tpl_start_schedule_table_abs_service,
    (tpl_system_call) tpl_stop_schedule_table_service,
    (tpl_system_call) tpl_next_schedule_table_service,
    (tpl_system_call) tpl_get_schedule_table_status_service,
    (tpl_system_call) tpl_get_isr_id_service,
    (tpl_system_call) tpl_start_schedule_table_synchron_service,
    (tpl_system_call) tpl_sync_schedule_table_service,
    (tpl_system_call) tpl_set_schedule_table_async_service
};
