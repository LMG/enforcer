 ...
 */
extern CONST(tpl_tick, OS_CONST) OSTICKSPERBASE_Hardware_Counter;
extern CONST(tpl_tick, OS_CONST) OSMAXALLOWEDVALUE_Hardware_Counter;
extern CONST(tpl_tick, OS_CONST) OSMINCYCLE_Hardware_Counter;
