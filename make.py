...
#----------------------------------------------------------------------
oilFile = "autosar_tp_s1.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=cortex/armv7/stm32f407/stm32f4discovery", "--templates=/home/lmg/trampoline/goil/templates"]
...
#--- Add generated files
sourceList.append("autosar_tp_s1/tpl_app_config.c")

sourceList.append("autosar_tp_s1/tpl_dispatch_table.c")
sourceList.append("autosar_tp_s1/tpl_invoque.S")
sourceList.append("autosar_tp_s1/tpl_primary_irq.S")
sourceList.append("autosar_tp_s1/tpl_vectors.c")
sourceList.append("autosar_tp_s1/tpl_external_interrupts.c")
